...
const publisher = 'Frappe Technologies'
const appName = 'frappe'
...
<template>
	<div class="h-screen flex">
		...
		<div class="flex flex-col w-full">
			...
			<div
				class="body-container bg-surface-white h-full pt-10 pb-40"
			...
			>
				...
				<div class="mt-4">
					...
					<div class="flex mt-2 gap-2">
						Today
						<DatePicker v-model="value" placeholder="Select Date" label="Label" /> is
						beautiful.
					</div>
				</div>
			</div>
